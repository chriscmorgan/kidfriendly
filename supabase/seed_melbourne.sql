...
begin
  ...
  insert into public.locations (id, slug, name, description, address, lat, lng, suburb, primary_category, additional_categories, age_ranges, tips, status, submitted_by, approved_at)
  values (v_loc_id, 'royal-botanic-gardens-melbourne', 'Royal Botanic Gardens Melbourne',
    ...
    'nature', array['playground'], array['toddler','preschool','primary','all_ages'],
  ...
  values (v_loc_id, 'melbourne-zoo-parkville', 'Melbourne Zoo',
    ...
    'entertainment', array['nature','activities'], array['toddler','preschool','primary','all_ages'],
  ...
  values (v_loc_id, 'scienceworks-spotswood', 'Scienceworks',
    ...
    'activities', array['entertainment'], array['toddler','preschool','primary'],
  ...
  values (v_loc_id, 'st-kilda-beach-foreshore', 'St Kilda Beach & Foreshore',
    ...
    'nature', array['sport_swim','playground'], array['toddler','preschool','primary','all_ages'],
  ...
  values (v_loc_id, 'collingwood-childrens-farm-abbotsford', 'Collingwood Children''s Farm',
    ...
    'nature', array['activities'], array['toddler','preschool','primary'],
  ...
  values (v_loc_id, 'bundoora-park-farm-bundoora', 'Bundoora Park Farm',
    ...
    'playground', array['nature','activities'], array['toddler','preschool','primary','all_ages'],
  ...
  values (v_loc_id, 'emerald-lake-park-emerald', 'Emerald Lake Park',
    ...
    'nature', array['playground','sport_swim'], array['toddler','preschool','primary','all_ages'],
  ...
  values (v_loc_id, 'pontoon-cafe-south-melbourne', 'Pontoon Cafe',
    ...
    'food_cafe', array['playground'], array['toddler','preschool','primary'],
  ...
  values (v_loc_id, 'fitzroy-swimming-pool-fitzroy-north', 'Fitzroy Swimming Pool',
    ...
    'sport_swim', array['playground'], array['toddler','preschool','primary'],
