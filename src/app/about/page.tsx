  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="space-y-8 text-[15px] leading-relaxed text-[#2c2c2c]">
        ...
        <div className="bg-[#edf8f8] border border-[#aadbd8] rounded-2xl p-6">
      ...
      <div className="mt-10 flex gap-3">
        <Link
          href="/"
          className="bg-[#4abfc0] text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-[#38a5a0] transition-colors"
        >
          Find spots near me
        </Link>
        <Link
