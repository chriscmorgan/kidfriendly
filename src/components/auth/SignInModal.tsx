      ...
      <div className="relative bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 w-full px-4 py-3 bg-black rounded-xl text-sm font-medium text-white hover:bg-gray-900 transition-colors cursor-pointer"
          >
